...
SIUnitRef unit = NULL;
AddSIToLibPrefixed(kSIQuantityLength, STR("meter"), STR("meters"), STR("m"), 1, &error);
AddSIToLibPrefixed(kSIQuantityMass, STR("gram"), STR("grams"), STR("g"), 0.001, &error);
AddSIToLibPrefixed(kSIQuantityTime, STR("second"), STR("seconds"), STR("s"), 1, &error);
AddSIToLibPrefixed(kSIQuantityCurrent, STR("ampere"), STR("amperes"), STR("A"), 1, &error);
AddSIToLibPrefixed(kSIQuantityTemperature, STR("kelvin"), STR("kelvin"), STR("K"), 1, &error);
AddSIToLibPrefixed(kSIQuantityAmount, STR("mole"), STR("moles"), STR("mol"), 1, &error);
AddSIToLibPrefixed(kSIQuantityLuminousIntensity, STR("candela"), STR("candelas"), STR("cd"), 1, &error);
#pragma mark kSIQuantityDimensionless
AddSIToLib(kSIQuantityDimensionless, STR("dimensionless"), STR("dimensionless"), STR(" "), 1, &error);
...
AddConstantToLib(kSIQuantityDimensionless, STR("euler number"), STR("euler number"), STR("exp(1)"), kSIEulersNumber, &error);
//
#pragma mark kSIQuantityFineStructureConstant
AddConstantToLib(kSIQuantityFineStructureConstant, STR("fine structure constant"), STR("fine structure constant"), STR("α"), alpha, &error);
AddConstantToLib(kSIQuantityFineStructureConstant, STR("inverse fine structure constant"), STR("inverse fine structure constant"), STR("(1/α)"), 1 / alpha, &error);
//
...
AddAtomicUnitToLib(kSIQuantityLength, STR("atomic unit of length"), STR("atomic unit of length"), STR("a_0"), a_0, &error);
...
AddPlanckUnitToLib(kSIQuantityLength, STR("planck length"), STR("planck length"), STR("l_P"), planckLength, &error);
//
#pragma mark kSIQuantityWavenumber, kSIQuantityInverseLength
AddSIToLib(kSIQuantityWavenumber, STR("inverse meter"), STR("inverse meters"), STR("(1/m)"), 1, &error);
AddSIToLib(kSIQuantityWavenumber, STR("inverse centimeter"), STR("inverse centimeters"), STR("(1/cm)"), 100, &error);
...
AddConstantToLib(kSIQuantityWavenumber, STR("rydberg constant"), STR("rydberg constant"), STR("R_∞"), R_H, &error);
AddAtomicUnitToLib(kSIQuantityWavenumber, STR("inverse atomic unit of length"), STR("inverse atomic unit of length"), STR("(1/a_0)"), 1 / a_0, &error);
...
AddSIToLibPrefixed(kSIQuantityLengthRatio, STR("meter per meter"), STR("meters per meter"), STR("m/m"), 1.0, &error);
AddSIToLibPrefixed(kSIQuantityLengthRatio, STR("radian"), STR("radians"), STR("rad"), 1.0, &error);
AddSIToLib(kSIQuantityLengthRatio, STR("degree"), STR("degrees"), STR("°"), kSIPi / 180., &error);
AddConstantToLib(kSIQuantityLengthRatio, STR("pi"), STR("pi"), STR("π"), kSIPi, &error);
...
AddSIToLibPrefixed(kSIQuantityMass, STR("tonne"), STR("tonnes"), STR("t"), 1e3, &error);
...
AddConstantToLib(kSIQuantityMass, STR("muon mass"), STR("muon mass"), STR("m_µ"), kSIMuonMass, &error);
...
AddSIToLibPrefixed(kSIQuantityMassRatio, STR("gram per kilogram"), STR("grams per kilogram"), STR("g/kg"), 0.001, &error);
//
...
AddPlanckUnitToLib(kSIQuantityTime, STR("planck time"), STR("planck time"), STR("t_P"), planckTime, &error);
//
#pragma mark kSIQuantityInverseTime
AddSIToLib(kSIQuantityInverseTime, STR("inverse seconds"), STR("inverse seconds"), STR("(1/s)"), 1., &error);
...
AddSIToLibPrefixed(kSIQuantityFrequency, STR("hertz"), STR("hertz"), STR("Hz"), 1.0, &error);
//
#pragma mark kSIQuantityRadioactivity
AddSIToLibPrefixed(kSIQuantityRadioactivity, STR("becquerel"), STR("becquerels"), STR("Bq"), 1.0, &error);
AddToLibPrefixed(kSIQuantityRadioactivity, STR("curie"), STR("curies"), STR("Ci"), 3.7e10, &error);
//
#pragma mark kSIQuantityFrequencyRatio
AddSIToLibPrefixed(kSIQuantityFrequencyRatio, STR("hertz per hertz"), STR("hertz per hertz"), STR("Hz/Hz"), 1., &error);
//
#pragma mark kSIQuantityTimeRatio
AddSIToLibPrefixed(kSIQuantityTimeRatio, STR("second per second"), STR("seconds per second"), STR("s/s"), 1., &error);
//
#pragma mark kSIQuantityInverseTimeSquared
AddSIToLib(kSIQuantityInverseTimeSquared, STR("inverse millisecond squared"), STR("inverse milliseconds squared"), STR("(1/ms^2)"), 1000000., &error);
AddSIToLib(kSIQuantityInverseTimeSquared, STR("inverse second squared"), STR("inverse seconds squared"), STR("(1/s^2)"), 1., &error);
...
AddSIToLibPrefixed(kSIQuantityLinearMomentum, STR("gram meter per second"), STR("gram meters per second"), STR("g•m/s"), 0.001, &error);
AddSIToLibPrefixed(kSIQuantityLinearMomentum, STR("newton second"), STR("newton seconds"), STR("N•s"), 1, &error);
AddAtomicUnitToLib(kSIQuantityLinearMomentum, STR("atomic unit of momentum"), STR("atomic units of momentum"), STR("ℏ/a_0"), hbar / a_0, &error);
//
...
AddSIToLibPrefixed(kSIQuantityEnergy, STR("joule"), STR("joules"), STR("J"), 1., &error);
AddSIToLibPrefixed(kSIQuantityEnergy, STR("watt hour"), STR("watt hour"), STR("W•h"), 3.6e3, &error);
AddConstantToLib(kSIQuantityEnergy, STR("rydberg"), STR("rydbergs"), STR("Ry"), Ry, &error);
AddConstantToLib(kSIQuantityEnergy, STR("alpha particle mass energy"), STR("alpha particle mass energy"), STR("m_a•c_0^2"), alphaParticleMassEnergy, &error);
...
AddAtomicUnitToLib(kSIQuantityEnergy, STR("atomic unit of energy"), STR("atomic unit of energy"), STR("E_h"), E_h, &error);
...
AddPlanckUnitToLib(kSIQuantityTemperature, STR("planck temperature"), STR("planck temperature"), STR("T_P"), planckTemperature, &error);
...
AddAtomicUnitToLib(kSIQuantityCurrent, STR("atomic unit of current"), STR("atomic unit of current"), STR("q_e•E_h/ℏ"), kSIElementaryCharge* E_h / hbar, &error);
//
#pragma mark kSIQuantityInverseCurrent
AddSIToLib(kSIQuantityInverseCurrent, STR("inverse ampere"), STR("inverse amperes"), STR("(1/A)"), 1., &error);
//
#pragma mark kSIQuantityCurrentRatio
AddSIToLibPrefixed(kSIQuantityCurrentRatio, STR("ampere per ampere"), STR("ampere per ampere"), STR("A/A"), 1., &error);
//
#pragma mark kSIQuantityInverseTemperature
AddSIToLib(kSIQuantityInverseTemperature, STR("inverse kelvin"), STR("inverse kelvin"), STR("(1/K)"), 1., &error);
//
#pragma mark kSIQuantityTemperatureRatio
AddSIToLibPrefixed(kSIQuantityTemperatureRatio, STR("kelvin per kelvin"), STR("kelvin per kelvin"), STR("K/K"), 1., &error);
//
#pragma mark kSIQuantityTemperatureGradient
AddSIToLibPrefixed(kSIQuantityTemperatureGradient, STR("kelvin per meter"), STR("kelvin per meter"), STR("K/m"), 1., &error);
...
AddSIToLib(kSIQuantityInverseAmount, STR("inverse mole"), STR("inverse moles"), STR("(1/mol)"), 1., &error);
AddConstantToLib(kSIQuantityInverseAmount, STR("avogadro constant"), STR("avogadro constant"), STR("N_A"), kSIAvogadroConstant, &error);
//
#pragma mark kSIQuantityAmountRatio
AddSIToLibPrefixed(kSIQuantityAmountRatio, STR("mole per mole"), STR("moles per mole"), STR("mol/mol"), 1., &error);
//
#pragma mark kSIQuantityInverseLuminousIntensity
AddSIToLib(kSIQuantityInverseLuminousIntensity, STR("inverse candela"), STR("inverse candelas"), STR("(1/cd)"), 1., &error);
//
#pragma mark kSIQuantityLuminousIntensityRatio
AddSIToLibPrefixed(kSIQuantityLuminousIntensityRatio, STR("candela per candela"), STR("candelas per candela"), STR("cd/cd"), 1., &error);
//
...
AddSIToLib(kSIQuantityArea, STR("square meter"), STR("square meters"), STR("m^2"), 1, &error);
AddSIToLib(kSIQuantityArea, STR("square centimeter"), STR("square centimeters"), STR("cm^2"), 0.0001, &error);
AddSIToLib(kSIQuantityArea, STR("square kilometer"), STR("square kilometers"), STR("km^2"), 1000000, &error);
...
AddSIToLib(kSIQuantitySolidAngle, STR("steradian"), STR("steradians"), STR("sr"), 1, &error);
//
#pragma mark kSIQuantityAreaRatio
AddSIToLib(kSIQuantityAreaRatio, STR("square meter per square meter"), STR("square meters per square meter"), STR("m^2/m^2"), 1, &error);
//
#pragma mark kSIQuantityVolume
AddSIToLibPrefixed(kSIQuantityVolume, STR("liter"), STR("liters"), STR("L"), 1e-3, &error);
...
AddSIToLib(kSIQuantityInverseVolume, STR("inverse liter"), STR("inverse liters"), STR("(1/L)"), 1. / 1e-3, &error);
AddSIToLib(kSIQuantityInverseVolume, STR("inverse milliliter"), STR("inverse milliliters"), STR("(1/mL)"), 1. / 1e-6, &error);
...
AddSIToLib(kSIQuantityInverseVolume, STR("inverse cubic centimeter"), STR("inverse cubic centimeters"), STR("(1/cm^3)"), 1000000., &error);
AddSIToLib(kSIQuantityInverseVolume, STR("inverse cubic millimeter"), STR("inverse cubic millimeters"), STR("(1/mm^3)"), 1000000000., &error);
AddSIToLib(kSIQuantityInverseVolume, STR("inverse cubic micrometer"), STR("inverse cubic micrometers"), STR("(1/µm^3)"), 1e+18, &error);
...
AddSIToLib(kSIQuantityVolumeRatio, STR("cubic meter per cubic meter"), STR("cubic meters per cubic meter"), STR("m^3/m^3"), 1, &error);
//
#pragma mark kSIQuantitySurfaceAreaToVolumeRatio
AddSIToLib(kSIQuantitySurfaceAreaToVolumeRatio, STR("square meter per cubic meter"), STR("square meters per cubic meter"), STR("m^2/m^3"), 1, &error);
AddSIToLib(kSIQuantitySurfaceAreaToVolumeRatio, STR("square meter per liter"), STR("square meters per liter"), STR("m^2/L"), 1000, &error);
//
#pragma mark kSIQuantitySpeed
AddSIToLibPrefixed(kSIQuantitySpeed, STR("meter per second"), STR("meters per second"), STR("m/s"), 1, &error);
...
AddAtomicUnitToLib(kSIQuantitySpeed, STR("atomic unit of velocity"), STR("atomic units of velocity"), STR("a_0•E_h/ℏ"), a_0* E_h / hbar, &error);
...
AddSIToLibPrefixed(kSIQuantityAngularMomentum, STR("joule second"), STR("joules second"), STR("J•s"), 1, &error);
AddSIToLibPrefixed(kSIQuantityAngularMomentum, STR("gram square meter per second"), STR("gram square meters per second"), STR("g•m^2/s"), 0.001, &error);
//
#pragma mark kSIQuantityAction
AddConstantToLib(kSIQuantityAction, STR("planck constant"), STR("planck constant"), STR("h_P"), kSIPlanckConstant, &error);
//
#pragma mark kSIQuantityReducedAction
AddConstantToLib(kSIQuantityReducedAction, STR("reduced planck constant"), STR("reduced planck constant"), STR("ℏ"), hbar, &error);
//
#pragma mark kSIQuantityCirculation
AddConstantToLib(kSIQuantityCirculation, STR("quantum of circulation"), STR("quantum of circulation"), STR("h_P/(2•m_e)"), hbar, &error);
//
#pragma mark kSIQuantitySecondRadiationConstant
AddConstantToLib(kSIQuantitySecondRadiationConstant, STR("second radiation constant"), STR("second radiation constant"), STR("h_P•c_0/k_B"), secondRadiationConstant, &error);
//
#pragma mark kSIQuantityElectricResistance
AddConstantToLib(kSIQuantityElectricResistance, STR("von klitzing constant"), STR("von klitzing constant"), STR("h_P/(q_e^2)"), vonKlitzingConstant, &error);
AddSIToLibPrefixed(kSIQuantityElectricResistance, STR("ohm"), STR("ohms"), STR("Ω"), 1., &error);
AddConstantToLib(kSIQuantityElectricResistance, STR("inverse conductance quantum"), STR("inverse conductance quantum"), STR("(1/G_0)"), 1 / G_0, &error);
AddConstantToLib(kSIQuantityElectricResistance, STR("characteristic impedance of vacuum"), STR("characteristic impedance of vacuum"), STR("Z_0"), 4 * kSIPi * 1.e-7 * kSISpeedOfLight, &error);
//
#pragma mark kSIQuantityAcceleration
AddSIToLibPrefixed(kSIQuantityAcceleration, STR("meter per square second"), STR("meters per square second"), STR("m/s^2"), 1, &error);
AddSIToLibPrefixed(kSIQuantityAcceleration, STR("meter per hour per second"), STR("meters per hour per second"), STR("m/(h•s)"), 1. / kSIHour, &error);
AddConstantToLib(kSIQuantityAcceleration, STR("gravity acceleration"), STR("gravity acceleration"), STR("g_0"), kSIGravityAcceleration, &error);
...
AddSIToLibPrefixed(kSIQuantityDensity, STR("gram per cubic meter"), STR("grams per cubic meter"), STR("g/m^3"), 1e-3, &error);
//
#pragma mark kSIQuantityMassFlowRate
AddSIToLibPrefixed(kSIQuantityMassFlowRate, STR("gram per second"), STR("grams per second"), STR("g/s"), 1e-3, &error);
//
#pragma mark kSIQuantityMassFlux
AddSIToLibPrefixed(kSIQuantityMassFlux, STR("gram per square meter per second"), STR("grams per square meter per second"), STR("g/(m^2•s)"), 1e-3, &error);
//
#pragma mark kSIQuantitySurfaceDensity
AddSIToLibPrefixed(kSIQuantitySurfaceDensity, STR("gram per square meter"), STR("grams per square meter"), STR("g/m^2"), 1e-3, &error);
//
#pragma mark kSIQuantityCurrentDensity
AddSIToLibPrefixed(kSIQuantityCurrentDensity, STR("ampere per square meter"), STR("amperes per square meter"), STR("A/m^2"), 1, &error);
//
#pragma mark kSIQuantityAmountConcentration
AddSIToLibPrefixed(kSIQuantityAmountConcentration, STR("mole per cubic meter"), STR("moles per cubic meter"), STR("mol/m^3"), 1., &error);
AddSIToLibPrefixed(kSIQuantityAmountConcentration, STR("mole per liter"), STR("moles per liter"), STR("mol/L"), 1000., &error);
AddSIToLibPrefixed(kSIQuantityAmountConcentration, STR("mole per milliliter"), STR("moles per milliliter"), STR("mol/mL"), 1000000., &error);
AddSIToLibPrefixed(kSIQuantityAmountConcentration, STR("mole per microliter"), STR("moles per microliter"), STR("mol/µL"), 1000000000., &error);
AddSIToLibPrefixed(kSIQuantityAmountConcentration, STR("mole per liter"), STR("moles per liter"), STR("M"), 1000., &error);
//
#pragma mark kSIQuantityMassConcentration
AddSIToLibPrefixed(kSIQuantityMassConcentration, STR("gram per liter"), STR("grams per liter"), STR("g/L"), 1, &error);
AddSIToLibPrefixed(kSIQuantityMassConcentration, STR("gram per milliliter"), STR("grams per milliliter"), STR("g/mL"), 1e3, &error);
AddSIToLibPrefixed(kSIQuantityMassConcentration, STR("gram per cubic centimeter"), STR("grams per cubic centimeter"), STR("g/cm^3"), 1e3, &error);
AddSIToLibPrefixed(kSIQuantityMassConcentration, STR("gram per microliter"), STR("grams per microliter"), STR("g/µL"), 1e6, &error);
//
#pragma mark kSIQuantityForce
AddSIToLibPrefixed(kSIQuantityForce, STR("newton"), STR("newtons"), STR("N"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityForce, STR("gram force"), STR("grams force"), STR("gf"), 0.00980665, &error);
//
#pragma mark kSIQuantityTorque
AddSIToLibPrefixed(kSIQuantityTorque, STR("newton meter per radian"), STR("newton meters per radian"), STR("N•m/rad"), 1., &error);
AddSIToLibPrefixed(kSIQuantityTorque, STR("joule per radian"), STR("joules per radian"), STR("J/rad"), 1., &error);
...
AddSIToLibPrefixed(kSIQuantityTorque, STR("gram force meter per radian"), STR("gram force meters per radian"), STR("gf•m/rad"), 0.00980665, &error);
AddSIToLibPrefixed(kSIQuantityTorque, STR("gram force centimeter per radian"), STR("gram force centimeters per radian"), STR("gf•cm/rad"), 9.80665e-05, &error);
//
#pragma mark kSIQuantityMomentOfInertia
AddSIToLib(kSIQuantityMomentOfInertia, STR("meter squared kilogram"), STR("meters squared kilogram"), STR("m^2•kg"), 1, &error);
AddSIToLib(kSIQuantityMomentOfInertia, STR("meter squared gram"), STR("meters squared gram"), STR("m^2•g"), 1.e-3, &error);
AddSIToLib(kSIQuantityMomentOfInertia, STR("centimeter squared kilogram"), STR("centimeter squared kilogram"), STR("cm^2•kg"), 0.0001, &error);
AddSIToLib(kSIQuantityMomentOfInertia, STR("centimeter squared gram"), STR("centimeter squared gram"), STR("cm^2•g"), 1.e-7, &error);
//
#pragma mark kSIQuantityPressure, kSIQuantityStress, kSIQuantityElasticModulus
AddSIToLibPrefixed(kSIQuantityPressure, STR("pascal"), STR("pascals"), STR("Pa"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityPressure, STR("newton per square meter"), STR("newtons per square meter"), STR("N/m^2"), 1, &error);
...
AddSIToLib(kSIQuantityCompressibility, STR("inverse pascal"), STR("inverse pascals"), STR("1/Pa"), 1, &error);
//
...
AddSIToLibPrefixed(kSIQuantityPressureGradient, STR("pascal per meter"), STR("pascals per meter"), STR("Pa/m"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantitySpectralRadiantEnergy, STR("joule per nanometer"), STR("joules per nanometer"), STR("J/nm"), 1.e9, &error);
//
#pragma mark kSIQuantityPower, kSIQuantityRadiantFlux
AddSIToLibPrefixed(kSIQuantityPower, STR("watt"), STR("watts"), STR("W"), 1, &error);
AddSIToLibPrefixed(kSIQuantityPower, STR("Joule per second"), STR("Joules per second"), STR("J/s"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantitySpectralPower, STR("watt per nanometer"), STR("watts per nanometer"), STR("W/nm"), 1.e9, &error);
//
#pragma mark kSIQuantityVolumePowerDensity
AddSIToLibPrefixed(kSIQuantityVolumePowerDensity, STR("watt per cubic meter"), STR("watts per cubic meter"), STR("W/m^3"), 1, &error);
AddSIToLibPrefixed(kSIQuantityVolumePowerDensity, STR("watt per cubic centimeter"), STR("watts per cubic centimeter"), STR("W/cm^3"), 100000., &error);
//
#pragma mark kSIQuantitySpecificPower
AddSIToLibPrefixed(kSIQuantitySpecificPower, STR("watt per kilogram"), STR("watts per kilogram"), STR("W/kg"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityElectricPotentialDifference, STR("volt"), STR("volts"), STR("V"), 1, &error);
AddAtomicUnitToLib(kSIQuantityElectricPotentialDifference, STR("atomic unit of electric potential"), STR("atomic units of electric potential"), STR("E_h/q_e"), E_h / kSIElementaryCharge, &error);
...
AddSIToLibPrefixed(kSIQuantityElectricResistancePerLength, STR("ohm per meter"), STR("ohms per meter"), STR("Ω/m"), 1, &error);
AddSIToLibPrefixed(kSIQuantityElectricResistancePerLength, STR("ohm per feet"), STR("ohms per feet"), STR("Ω/ft"), 1. / (kSIMile / 5280), &error);
//
#pragma mark kSIQuantityElectricResistivity
AddSIToLibPrefixed(kSIQuantityElectricResistivity, STR("ohm meter"), STR("ohms meter"), STR("Ω•m"), 1, &error);
AddSIToLibPrefixed(kSIQuantityElectricResistivity, STR("ohm centimeter"), STR("ohms centimeter"), STR("Ω•cm"), 0.01, &error);
//
#pragma mark kSIQuantityElectricConductance
AddSIToLibPrefixed(kSIQuantityElectricConductance, STR("siemen"), STR("siemens"), STR("S"), 1, &error);
AddConstantToLib(kSIQuantityElectricConductance, STR("conductance quantum"), STR("conductance quantum"), STR("G_0"), G_0, &error);
//
#pragma mark kSIQuantityElectricConductivity
AddSIToLibPrefixed(kSIQuantityElectricConductivity, STR("siemen per meter"), STR("siemens per meter"), STR("S/m"), 1, &error);
AddSIToLibPrefixed(kSIQuantityElectricConductivity, STR("siemen per centimeter"), STR("siemens per centimeter"), STR("S/cm"), 100., &error);
//
#pragma mark kSIQuantityMolarConductivity
AddSIToLibPrefixed(kSIQuantityMolarConductivity, STR("siemen meter squared per mole"), STR("siemens meter squared per mole"), STR("S•m^2/mol"), 1, &error);
AddSIToLibPrefixed(kSIQuantityMolarConductivity, STR("siemen centimeter squared per mole"), STR("siemens centimeter squared per mole"), STR("S•cm^2/mol"), 0.0001, &error);
//
#pragma mark kSIQuantityGyromagneticRatio
AddSIToLib(kSIQuantityGyromagneticRatio, STR("radian per second per tesla"), STR("radians per second per tesla"), STR("rad/(s•T)"), 1, &error);
//
#pragma mark kSIQuantityMagneticDipoleMoment
AddSIToLibPrefixed(kSIQuantityMagneticDipoleMoment, STR("ampere square meter"), STR("ampere square meters"), STR("A•m^2"), 1, &error);
AddSIToLibPrefixed(kSIQuantityMagneticDipoleMoment, STR("joule per tesla"), STR("joules per tesla"), STR("J/T"), 1, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMoment, STR("nuclear magneton"), STR("nuclear magnetons"), STR("µ_N"), mu_N, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMoment, STR("bohr magneton"), STR("bohr magnetons"), STR("µ_B"), mu_e, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMoment, STR("proton magnetic moment"), STR("proton magnetic moment"), STR("µ_p"), kSIProtonMagneticMoment, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMoment, STR("neutron magnetic moment"), STR("neutron magnetic moment"), STR("µ_n"), kSINeutronMagneticMoment, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMoment, STR("electron magnetic moment"), STR("electron magnetic moment"), STR("µ_e"), kSIElectronMagneticMoment, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMoment, STR("muon magnetic moment"), STR("muon magnetic moment"), STR("µ_µ"), kSIMuonMagneticMoment, &error);
AddAtomicUnitToLib(kSIQuantityMagneticDipoleMoment, STR("atomic unit of magnetic dipole moment"), STR("atomic units of magnetic dipole moment"), STR("ℏ•q_e/m_e"), hbar* kSIElementaryCharge / kSIElectronMass, &error);
//
#pragma mark kSIQuantityMagneticDipoleMomentRatio
AddConstantToLib(kSIQuantityMagneticDipoleMomentRatio, STR("proton g factor"), STR("proton g factor"), STR("g_p"), kSIProtonGFactor, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMomentRatio, STR("neutron g factor"), STR("neutron g factor"), STR("g_n"), kSINeutronGFactor, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMomentRatio, STR("electron g factor"), STR("electron g factor"), STR("g_e"), kSIElectronGFactor, &error);
AddConstantToLib(kSIQuantityMagneticDipoleMomentRatio, STR("muon g factor"), STR("muon g factor"), STR("g_µ"), kSIMuonGFactor, &error);
//
#pragma mark kSIQuantityMagneticFlux
AddSIToLibPrefixed(kSIQuantityMagneticFlux, STR("weber"), STR("webers"), STR("Wb"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityMagneticFluxDensity, STR("tesla"), STR("tesla"), STR("T"), 1, &error);
AddAtomicUnitToLib(kSIQuantityMagneticFluxDensity, STR("atomic unit of magnetic flux density"), STR("atomic units of magnetic flux density"), STR("ℏ/(q_e•a_0^2)"), hbar / (kSIElementaryCharge * a_0 * a_0), &error);
AddCGSToLibPrefixed(kSIQuantityMagneticFluxDensity, STR("gauss"), STR("gauss"), STR("G"), 1e-4, &error);
//
#pragma mark kSIQuantityMagneticFieldGradient
AddSIToLibPrefixed(kSIQuantityMagneticFieldGradient, STR("tesla per meter"), STR("tesla per meter"), STR("T/m"), 1, &error);
AddSIToLibPrefixed(kSIQuantityMagneticFieldGradient, STR("tesla per centimeter"), STR("tesla per centimeter"), STR("T/cm"), 100., &error);
...
AddSIToLib(kSIQuantityMolarMagneticSusceptibility, STR("cubic meter per mole"), STR("cubic meters per mole"), STR("m^3/mol"), 1., &error);
AddSIToLib(kSIQuantityMolarMagneticSusceptibility, STR("cubic centimeter per mole"), STR("cubic centimeters per mole"), STR("cm^3/mol"), 1e-06, &error);
//
#pragma mark kSIQuantityInductance
AddSIToLibPrefixed(kSIQuantityInductance, STR("henry"), STR("henries"), STR("H"), 1, &error);
//
#pragma mark kSIQuantityLuminousFlux
AddSIToLibPrefixed(kSIQuantityLuminousFlux, STR("lumen"), STR("lumens"), STR("lm"), 1., &error);
AddSIToLibPrefixed(kSIQuantityLuminousFlux, STR("candela steradian"), STR("candela steradians"), STR("cd•sr"), 1, &error);
//
#pragma mark kSIQuantityLuminousFluxDensity
AddSIToLibPrefixed(kSIQuantityLuminousFluxDensity, STR("lumen per square meter"), STR("lumens per square meter"), STR("lm/m^2"), 1., &error);
AddSIToLibPrefixed(kSIQuantityLuminousFluxDensity, STR("lumen per square foot"), STR("lumens per square foot"), STR("lm/ft^2"), 10.76391041670972, &error);
//
#pragma mark kSIQuantityLuminousEnergy
AddSIToLibPrefixed(kSIQuantityLuminousEnergy, STR("lumen second"), STR("lumen seconds"), STR("lm•s"), 1, &error);
//
#pragma mark kSIQuantityIlluminance
AddSIToLibPrefixed(kSIQuantityIlluminance, STR("lux"), STR("lux"), STR("lx"), 1, &error);
AddToLibPrefixed(kSIQuantityIlluminance, STR("phot"), STR("phots"), STR("ph"), 1e4, &error);
//
#pragma mark kSIQuantityAbsorbedDose
AddSIToLibPrefixed(kSIQuantityAbsorbedDose, STR("gray"), STR("grays"), STR("Gy"), 1, &error);
//
#pragma mark kSIQuantityDoseEquivalent
AddSIToLibPrefixed(kSIQuantityDoseEquivalent, STR("sievert"), STR("sieverts"), STR("Sv"), 1, &error);
//
#pragma mark kSIQuantityCatalyticActivity
AddSIToLibPrefixed(kSIQuantityCatalyticActivity, STR("mole per second"), STR("moles per second"), STR("mol/s"), 1, &error);
AddSIToLibPrefixed(kSIQuantityCatalyticActivity, STR("katal"), STR("katals"), STR("kat"), 1, &error);
AddSIToLibPrefixed(kSIQuantityCatalyticActivity, STR("mole per minute"), STR("moles per minute"), STR("mol/min"), 1. / kSIMinute, &error);
//
#pragma mark kSIQuantityCatalyticActivityConcentration
AddSIToLibPrefixed(kSIQuantityCatalyticActivityConcentration, STR("katal per cubic meter"), STR("katals per cubic meter"), STR("kat/m^3"), 1, &error);
AddSIToLibPrefixed(kSIQuantityCatalyticActivityConcentration, STR("katal per liter"), STR("katals per liter"), STR("kat/L"), 1000., &error);
//
#pragma mark kSIQuantityCatalyticActivityContent
AddSIToLibPrefixed(kSIQuantityCatalyticActivityContent, STR("katal per kilogram"), STR("katals per kilogram"), STR("kat/kg"), 1, &error);
//
#pragma mark kSIQuantityRatePerAmountConcentrationPerTime
AddSIToLibPrefixed(kSIQuantityRatePerAmountConcentrationPerTime, STR("liter per mole per second"), STR("liter per mole per second"), STR("L/(mol•s)"), 0.001, &error);
//
#pragma mark kSIQuantityRefractiveIndex
AddSIToLibPrefixed(kSIQuantityRefractiveIndex, STR("meter second per meter second"), STR("meter seconds per meter second"), STR("m•s/(m•s)"), 1, &error);
//
#pragma mark kSIQuantityElectricQuadrupoleMoment
AddAtomicUnitToLib(kSIQuantityElectricQuadrupoleMoment, STR("atomic unit of electric quadrupole moment"), STR("atomic units of electric quadrupole moment"), STR("q_e•a_0^2"), kSIElementaryCharge* a_0* a_0, &error);
//
#pragma mark kSIQuantityMagnetizability
AddAtomicUnitToLib(kSIQuantityMagnetizability, STR("atomic unit of magnetizability"), STR("atomic units of magnetizability"), STR("q_e•a_0^2/m_e"), kSIElementaryCharge* a_0* a_0 / kSIElectronMass, &error);
//
#pragma mark kSIQuantityPermittivity
AddAtomicUnitToLib(kSIQuantityPermittivity, STR("atomic unit of permittivity"), STR("atomic units of permittivity"), STR("q_e^2/(a_0•E_h)"), kSIElementaryCharge* kSIElementaryCharge / (a_0 * E_h), &error);
AddSIToLibPrefixed(kSIQuantityPermittivity, STR("farad per meter"), STR("farads per meter"), STR("F/m"), 1, &error);
AddSIToLibPrefixed(kSIQuantityPermittivity, STR("coulomb per volt meter"), STR("coulombs per volt meter"), STR("C/(V•m)"), 1, &error);
AddConstantToLib(kSIQuantityPermittivity, STR("electric constant"), STR("electric constant"), STR("ε_0"), kSIElectricConstant, &error);
//
#pragma mark kSIQuantityElectricPolarizability
AddAtomicUnitToLib(kSIQuantityElectricPolarizability, STR("atomic unit of electric polarizability"), STR("atomic units of electric polarizability"), STR("q_e^2•a_0^2/E_h"), kSIElementaryCharge* kSIElementaryCharge* a_0* a_0 / (E_h), &error);
//
#pragma mark kSIQuantityFirstHyperPolarizability
AddAtomicUnitToLib(kSIQuantityFirstHyperPolarizability, STR("atomic unit of 1st polarizability"), STR("atomic units of 1st polarizability"), STR("q_e^3•a_0^3/E_h^2"), kSIElementaryCharge* kSIElementaryCharge* kSIElementaryCharge* a_0* a_0* a_0 / (E_h * E_h), &error);
//
#pragma mark kSIQuantitySecondHyperPolarizability
AddAtomicUnitToLib(kSIQuantitySecondHyperPolarizability, STR("atomic unit of 2nd polarizability"), STR("atomic units of 2nd polarizability"), STR("q_e^4•a_0^4/E_h^3"), kSIElementaryCharge* kSIElementaryCharge* kSIElementaryCharge* kSIElementaryCharge* a_0* a_0* a_0* a_0 / (E_h * E_h * E_h), &error);
//
#pragma mark kSIQuantitySpecificVolume
AddSIToLib(kSIQuantitySpecificVolume, STR("cubic meter per kilogram"), STR("cubic meters per kilogram"), STR("m^3/kg"), 1., &error);
//
#pragma mark kSIQuantityMassToChargeRatio
AddConstantToLib(kSIQuantityMassToChargeRatio, STR("thomson"), STR("thomson"), STR("Th"), kSIAtomicMassConstant / kSIElementaryCharge, &error);
//
#pragma mark kSIQuantityChargeToMassRatio
AddConstantToLib(kSIQuantityChargeToMassRatio, STR("inverse thomson"), STR("inverse thomson"), STR("(1/Th)"), kSIElementaryCharge / kSIAtomicMassConstant, &error);
//
#pragma mark kSIQuantityDynamicViscosity
AddToLibPrefixed(kSIQuantityDynamicViscosity, STR("poise"), STR("poises"), STR("P"), 0.1, &error);
AddSIToLib(kSIQuantityDynamicViscosity, STR("pascal second"), STR("pascal seconds"), STR("Pa•s"), 1, &error);
AddSIToLib(kSIQuantityDynamicViscosity, STR("newton second per square meter"), STR("newton seconds per square meter"), STR("N•s/m^2"), 1, &error);
//
...
AddSIToLib(kSIQuantityDiffusionCoefficient, STR("square meter per second"), STR("square meters per second"), STR("m^2/s"), 1, &error);
AddSIToLib(kSIQuantityDiffusionCoefficient, STR("square centimeter per second"), STR("square centimeters per second"), STR("cm^2/s"), 0.0001, &error);
AddSIToLib(kSIQuantityDiffusionCoefficient, STR("square millimeter per second"), STR("square millimeters per second"), STR("mm^2/s"), 1e-6, &error);
//
#pragma mark kSIQuantityLuminance
AddToLibPrefixed(kSIQuantityLuminance, STR("stilb"), STR("stilbs"), STR("sb"), 1e4, &error);
AddSIToLibPrefixed(kSIQuantityLuminance, STR("lumen per square meter per steradian"), STR("lumens per square meter per steradian"), STR("lm/(m^2•sr)"), 1, &error);
//
#pragma mark kSIQuantityInverseMagneticFluxDensity
AddCGSToLib(kSIQuantityInverseMagneticFluxDensity, STR("inverse gauss"), STR("inverse gauss"), STR("(1/G)"), 1., &error);
//
#pragma mark kSIQuantityMagneticFieldStrength
AddSIToLibPrefixed(kSIQuantityMagneticFieldStrength, STR("ampere per meter"), STR("amperes per meter"), STR("A/m"), 1, &error);
AddCGSToLibPrefixed(kSIQuantityMagneticFieldStrength, STR("œrsted"), STR("œrsteds"), STR("Oe"), 79.577471545947674, &error);
//
#pragma mark kSIQuantityMomentOfForce
AddSIToLibPrefixed(kSIQuantityMomentOfForce, STR("newton meter"), STR("newton meters"), STR("N•m"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantitySurfaceTension, STR("newton per meter"), STR("newtons per meter"), STR("N/m"), 1, &error);
AddCGSToLibPrefixed(kSIQuantitySurfaceTension, STR("dyne per centimeter"), STR("dynes per centimeter"), STR("dyn/cm"), 0.001, &error);
//
#pragma mark kSIQuantitySurfaceEnergy
AddSIToLibPrefixed(kSIQuantitySurfaceEnergy, STR("joule per square meter"), STR("joules per square meter"), STR("J/m^2"), 1, &error);
AddCGSToLibPrefixed(kSIQuantitySurfaceEnergy, STR("dyne per square centimeter"), STR("dynes per square centimeter"), STR("dyn/cm^2"), 0.1, &error);
//
#pragma mark kSIQuantityAngularSpeed, kSIQuantityAngularVelocity
AddSIToLib(kSIQuantityAngularSpeed, STR("radian per second"), STR("radians per second"), STR("rad/s"), 1, &error);
...
AddSIToLib(kSIQuantityAngularAcceleration, STR("radian per square second"), STR("radians per square second"), STR("rad/s^2"), 1, &error);
//
#pragma mark kSIQuantityHeatFluxDensity, kSIQuantityIrradiance
AddSIToLibPrefixed(kSIQuantityHeatFluxDensity, STR("watt per square meter"), STR("watts per square meter"), STR("W/m^2"), 1, &error);
AddSIToLibPrefixed(kSIQuantityHeatFluxDensity, STR("watt per square centimeter"), STR("watts per square centimeter"), STR("W/cm^2"), 10000., &error);
...
AddSIToLibPrefixed(kSIQuantitySpectralRadiantFluxDensity, STR("watt per square meter per nanometer"), STR("watts per square meter per nanometer"), STR("W/(m^2•nm)"), 1.e9, &error);
//
#pragma mark kSIQuantityEntropy, kSIQuantityHeatCapacity
AddSIToLibPrefixed(kSIQuantityEntropy, STR("joule per kelvin"), STR("joules per kelvin"), STR("J/K"), 1, &error);
AddConstantToLib(kSIQuantityEntropy, STR("boltzmann constant"), STR("boltzmann constant"), STR("k_B"), kSIBoltmannConstant, &error);
...
AddSIToLibPrefixed(kSIQuantitySpecificHeatCapacity, STR("joule per kilogram kelvin"), STR("joules per kilogram kelvin"), STR("J/(kg•K)"), 1, &error);
AddSIToLibPrefixed(kSIQuantitySpecificHeatCapacity, STR("joule per gram kelvin"), STR("joules per gram kelvin"), STR("J/(g•K)"), 1000., &error);
...
AddSIToLibPrefixed(kSIQuantityMolarMass, STR("gram per mole"), STR("grams per mole"), STR("g/mol"), 1e-3, &error);
//
#pragma mark kSIQuantityMolality
AddSIToLibPrefixed(kSIQuantityMolality, STR("mole per kilogram"), STR("moles per kilogram"), STR("mol/kg"), 1, &error);
//
#pragma mark kSIQuantitySpecificEnergy
AddSIToLibPrefixed(kSIQuantitySpecificEnergy, STR("joule per kilogram"), STR("joules per kilogram"), STR("J/kg"), 1, &error);
AddSIToLibPrefixed(kSIQuantitySpecificEnergy, STR("joule per gram"), STR("joules per gram"), STR("J/g"), 1e3, &error);
//
#pragma mark kSIQuantityThermalConductance
AddSIToLibPrefixed(kSIQuantityThermalConductance, STR("watt per kelvin"), STR("watts per kelvin"), STR("W/K"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityThermalConductivity, STR("watt per meter kelvin"), STR("watts per meter kelvin"), STR("W/(m•K)"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityEnergyDensity, STR("joule per cubic meter"), STR("joules per cubic meter"), STR("J/m^3"), 1, &error);
AddSIToLibPrefixed(kSIQuantityEnergyDensity, STR("joule per liter"), STR("joules per liter"), STR("J/L"), 1000., &error);
//
#pragma mark kSIQuantityElectricDipoleMoment
AddSIToLibPrefixed(kSIQuantityElectricDipoleMoment, STR("coulomb meter"), STR("coulomb meters"), STR("C•m"), 1, &error);
AddToLib(kSIQuantityElectricDipoleMoment, STR("debye"), STR("debyes"), STR("D"), 3.335640951816991e-30, &error);
AddAtomicUnitToLib(kSIQuantityElectricDipoleMoment, STR("atomic unit of electric dipole moment"), STR("atomic unit of electric dipole moment"), STR("q_e•a_0"), kSIElementaryCharge* a_0, &error);
//
#pragma mark kSIQuantityElectricFieldStrength
AddSIToLibPrefixed(kSIQuantityElectricFieldStrength, STR("volt per meter"), STR("volts per meter"), STR("V/m"), 1, &error);
AddAtomicUnitToLib(kSIQuantityElectricFieldStrength, STR("atomic unit of electric field"), STR("atomic unit of electric field"), STR("E_h/(q_e•a_0)"), E_h / (kSIElementaryCharge * a_0), &error);
AddSIToLibPrefixed(kSIQuantityElectricFieldStrength, STR("volt per centimeter"), STR("volts per centimeter"), STR("V/cm"), 1, &error);
AddSIToLibPrefixed(kSIQuantityElectricFieldStrength, STR("newton per coulomb"), STR("newtons per coulomb"), STR("N/C"), 1, &error);
//
#pragma mark kSIQuantityElectricFlux
AddSIToLibPrefixed(kSIQuantityElectricFlux, STR("volt meter"), STR("volts meter"), STR("V•m"), 1, &error);
//
#pragma mark kSIQuantityElectricChargeDensity
AddSIToLibPrefixed(kSIQuantityElectricChargeDensity, STR("coulomb per cubic meter"), STR("coulombs per cubic meter"), STR("C/m^3"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantitySurfaceChargeDensity, STR("coulomb per square meter"), STR("coulombs per square meter"), STR("C/m^2"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityPermeability, STR("henry per meter"), STR("henries per meter"), STR("H/m"), 1., &error);
AddSIToLibPrefixed(kSIQuantityPermeability, STR("newton per square ampere"), STR("newtons per square ampere"), STR("N/A^2"), 1, &error);
AddSIToLibPrefixed(kSIQuantityPermeability, STR("tesla meter per ampere"), STR("tesla meter per ampere"), STR("T•m/A"), 1, &error);
AddCGSToLibPrefixed(kSIQuantityPermeability, STR("weber per ampere meter"), STR("webers per ampere meter"), STR("Wb/(A•m)"), 1, &error);
AddConstantToLib(kSIQuantityPermeability, STR("magnetic constant"), STR("magnetic constant"), STR("µ_0"), 4 * kSIPi * 1.e-7, &error);
//
#pragma mark kSIQuantityMolarEntropy, kSIQuantityMolarHeatCapacity
AddSIToLibPrefixed(kSIQuantityMolarEntropy, STR("joule per mole kelvin"), STR("joules per mole kelvin"), STR("J/(mol•K)"), 1, &error);
AddConstantToLib(kSIQuantityMolarEntropy, STR("gas constant"), STR("gas constant"), STR("R"), kSIBoltmannConstant* kSIAvogadroConstant, &error);
...
AddSIToLibPrefixed(kSIQuantityMolarEnergy, STR("joule per mole"), STR("joules per mole"), STR("J/mol"), 1, &error);
...
AddSIToLibPrefixed(kSIQuantityRadiationExposure, STR("coulomb per kilogram"), STR("coulombs per kilogram"), STR("C/kg"), 1, &error);
//
#pragma mark kSIQuantityAbsorbedDoseRate
AddSIToLibPrefixed(kSIQuantityAbsorbedDoseRate, STR("gray per second"), STR("grays per second"), STR("Gy/s"), 1, &error);
//
#pragma mark kSIQuantityRadiantIntensity
AddSIToLibPrefixed(kSIQuantityRadiantIntensity, STR("watt per steradian"), STR("watts per steradian"), STR("W/sr"), 1, &error);
//
...
AddSIToLibPrefixed(kSIQuantityRadiance, STR("watt per square meter per steradian"), STR("watts per square meter per steradian"), STR("W/(m^2•sr)"), 1, &error);
//
#pragma mark kSIQuantitySpectralRadiance
AddSIToLibPrefixed(kSIQuantitySpectralRadiance, STR("watt per square meter per steradian per nanometer"), STR("watts per square meter steradian per nanometer"), STR("W/(m^2•sr•nm)"), 1.e9, &error);
//
#pragma mark kSIQuantityFrequencyPerMagneticFluxDensity
AddSIToLibPrefixed(kSIQuantityFrequencyPerMagneticFluxDensity, STR("hertz per tesla"), STR("hertz per tesla"), STR("Hz/T"), 1, &error);
//
#pragma mark kSIQuantityLengthPerVolume
AddSIToLibPrefixed(kSIQuantityLengthPerVolume, STR("meter per liter"), STR("meters per liter"), STR("m/L"), 1. / 1.e-3, &error);
//
#pragma mark kSIQuantityPowerPerLuminousFlux
AddSIToLibPrefixed(kSIQuantityPowerPerLuminousFlux, STR("watt per lumen"), STR("watts per lumen"), STR("W/lm"), 1, &error);
//
#pragma mark kSIQuantityLuminousEfficacy
AddSIToLibPrefixed(kSIQuantityLuminousEfficacy, STR("lumen per watt"), STR("lumens per watt"), STR("lm/W"), 1, &error);
//
#pragma mark kSIQuantityHeatTransferCoefficient
AddSIToLibPrefixed(kSIQuantityHeatTransferCoefficient, STR("watt per square meter per kelvin"), STR("watts per square meter per kelvin"), STR("W/(m^2•K)"), 1, &error);
...
AddConstantToLib(kSIQuantityChargePerAmount, STR("faraday constant"), STR("faraday constant"), STR("&F"), kSIElementaryCharge* kSIAvogadroConstant, &error);
AddSIToLibPrefixed(kSIQuantityChargePerAmount, STR("coulomb per mole"), STR("coulombs per mole"), STR("C/mol"), 1.0, &error);
//
...
AddSIToLib(kSIQuantityVolumetricFlowRate, STR("cubic meter per second"), STR("cubic meters per second"), STR("m^3/s"), 1., &error);
...
AddSIToLib(kSIQuantityVolumetricFlowRate, STR("cubic centimeter per second"), STR("cubic centimeters per second"), STR("cm^3/s"), 1e-6, &error);
...
AddConstantToLib(kSIQuantityPowerPerAreaPerTemperatureToFourthPower, STR("stefan-boltzmann constant"), STR("stefan-boltzmann constant"), STR("σ"), kSIStefanBoltzmannConstant, &error);
//
#pragma mark kSIQuantityWavelengthDisplacementConstant
AddConstantToLib(kSIQuantityWavelengthDisplacementConstant, STR("wien wavelength displacement constant"), STR("wien wavelength displacement constant"), STR("b_λ"), kSIWeinDisplacementConstant, &error);
//
