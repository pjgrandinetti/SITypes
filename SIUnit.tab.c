...
#define yyparse siuparse
#define yylex   siulex
#define yyerror siuerror
#define yylval  siulval
#define yychar  siuchar
#define yydebug siudebug
#define yynerrs siunerrs
...
{
  "$end", "error", "$undefined", "UNIT", "INTEGER", "'*'", "'/'", "'^'",
...
#line 26 "src/SIUnitParser.y"
  ...
  case 4:
#line 29 "src/SIUnitParser.y"
    {(yyval.unit) = (yyvsp[(2) - (3)].unit);}
    break;

  case 5:
#line 30 "src/SIUnitParser.y"
    {(yyval.unit) = SIUnitByMultiplyingWithoutReducing((yyvsp[(1) - (3)].unit),(yyvsp[(3) - (3)].unit),unit_multiplier_ref, &unitError);}
    break;

  case 6:
#line 31 "src/SIUnitParser.y"
    {(yyval.unit) = SIUnitByDividingWithoutReducing((yyvsp[(1) - (3)].unit),(yyvsp[(3) - (3)].unit),unit_multiplier_ref);}
    break;

  case 7:
#line 32 "src/SIUnitParser.y"
    {(yyval.unit) = SIUnitByRaisingToAPowerWithoutReducing((yyvsp[(1) - (3)].unit),(yyvsp[(3) - (3)].iVal),unit_multiplier_ref, &unitError);}
    break;

  case 8:
#line 33 "src/SIUnitParser.y"
    {
    if((yyvsp[(1) - (3)].iVal) == 1) {(yyval.unit) = SIUnitByRaisingToAPowerWithoutReducing((yyvsp[(3) - (3)].unit),-1,unit_multiplier_ref, &unitError);}
    else  {
